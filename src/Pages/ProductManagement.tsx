        ...
        <div className="mt-4">
            ...
            </div>
            {
                data.data.length > 0 && <div>
                    {
                        data.data.map((product: TProduct) => <div key={product._id} className="flex flex-col md:flex-row justify-between md:items-center rounded-xl max-w-4xl border shadow-xl mt-10 px-5 mx-auto">
